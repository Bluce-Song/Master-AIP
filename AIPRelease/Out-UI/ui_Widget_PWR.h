...
public:
    ...
    QDoubleSpinBox *noise_time;
    QCheckBox *noise_enable;
    QLabel *label_pg_volt_2;
    ...
    void setupUi(QWidget *Widget_PWR)
    {
        ...
        checkBox_pwm->setGeometry(QRect(20, 10, 91, 41));
        checkBox_pwm->setMinimumSize(QSize(91, 41));
        checkBox_pwm->setMaximumSize(QSize(91, 41));
        QFont font1;
...
""));
        ...
        checkBox_3->setGeometry(QRect(20, 60, 151, 41));
...
""));
        ...
        label_grade_10->setGeometry(QRect(460, 10, 111, 41));
        ...
        PWR_Volume_value->setGeometry(QRect(570, 10, 71, 41));
        ...
        horizontalLayoutWidget->setGeometry(QRect(160, 60, 562, 43));
        ...
        toolButton_4->setGeometry(QRect(640, 20, 71, 41));
...
"}"));
        noise_time = new QDoubleSpinBox(Widget_PWR);
        noise_time->setObjectName(QString::fromUtf8("noise_time"));
        noise_time->setGeometry(QRect(384, 10, 51, 41));
        noise_time->setAlignment(Qt::AlignCenter);
        noise_time->setButtonSymbols(QAbstractSpinBox::NoButtons);
        noise_time->setDecimals(1);
        noise_time->setMinimum(0);
        noise_time->setMaximum(30);
        noise_time->setSingleStep(0.1);
        noise_time->setValue(5);
        noise_enable = new QCheckBox(Widget_PWR);
        noise_enable->setObjectName(QString::fromUtf8("noise_enable"));
        noise_enable->setEnabled(true);
        noise_enable->setGeometry(QRect(160, 10, 121, 41));
        noise_enable->setFont(font);
        noise_enable->setStyleSheet(QString::fromUtf8(" QCheckBox::indicator {\n"
"	color: rgb(255, 255, 255);\n"
"image: url(:/image/053.png);\n"
"      width: 50px;\n"
"      height: 55px;\n"
...
";}\");\n"
""));
        noise_enable->setIconSize(QSize(8, 8));
        noise_enable->setAutoRepeatDelay(300);
        label_pg_volt_2 = new QLabel(Widget_PWR);
        label_pg_volt_2->setObjectName(QString::fromUtf8("label_pg_volt_2"));
        label_pg_volt_2->setGeometry(QRect(310, 10, 71, 41));
        label_pg_volt_2->setFont(font);
        label_pg_volt_2->setStyleSheet(QString::fromUtf8("border: 0px solid white;"));
        label_pg_volt_2->setAlignment(Qt::AlignCenter);
    ...
    void retranslateUi(QWidget *Widget_PWR)
    {
        ...
        noise_enable->setText(QApplication::translate("Widget_PWR", "\345\231\252\351\237\263\346\265\213\350\257\225", 0, QApplication::UnicodeUTF8));
        label_pg_volt_2->setText(QApplication::translate("Widget_PWR", "\346\227\266\351\227\264(s)\357\274\232", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
