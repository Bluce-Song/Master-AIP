...
"border-radius:12px;"));
        ...
        TLabel08->setGeometry(QRect(100, 440, 101, 41));
...
""));
    ...
    void retranslateUi(QWidget *w_Conf)
    {
        ...
        TLabel08->setText(QApplication::translate("w_Conf", "\345\236\213\345\217\267", 0, QApplication::UnicodeUTF8));
